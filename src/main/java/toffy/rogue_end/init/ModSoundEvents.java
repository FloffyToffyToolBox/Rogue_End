...
public class ModSoundEvents {
    ...
    public static final SoundEvent ENTITY_MISC_TELEPORT_IN = registerSound("entity.misc.teleport_in");

    public static final SoundEvent ENTITY_ENDLING_ATTACK = registerSound("entity.endling.attack");
    public static final SoundEvent ENTITY_ENDLING_DEATH = registerSound("entity.endling.death");
    public static final SoundEvent ENTITY_ENDLING_HURT = registerSound("entity.endling.hurt");
