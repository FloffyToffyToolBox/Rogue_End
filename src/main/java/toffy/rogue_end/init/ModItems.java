...
public class ModItems {
    public static final Item BACK_STABBER = registerItem("backstabber", (new BackstabberItem((new Item.Settings()).rarity(Rarity.EPIC).maxDamage(500).component(DataComponentTypes.TOOL, BackstabberItem.createToolComponent()).attributeModifiers(BackstabberItem.createAttributeModifiers()))));
    ...
    public static final Item PURIFIED_VOID_AMULET = registerItem("purified_void_amulet", (new Item(new Item.Settings())));
    public static final Item CORRUPTED_VOID_AMULET = registerItem("corrupted_void_amulet", (new CorruptedAmuletItem(new Item.Settings())));
