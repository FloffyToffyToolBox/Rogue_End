...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        PlacedFeatures.register(context, YELLOW_TREES, registryEntry3, new PlacementModifier[]{PlacedFeatures.createCountExtraModifier(10, 0.1F, 1), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of()});
