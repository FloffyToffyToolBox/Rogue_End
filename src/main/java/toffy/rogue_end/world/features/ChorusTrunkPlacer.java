...
public class ChorusTrunkPlacer extends TrunkPlacer {
    ...
    public static final MapCodec<ChorusTrunkPlacer> CODEC;
    ...
    public ChorusTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight, IntProvider branchCount, IntProvider branchHorizontalLength, UniformIntProvider branchStartOffsetFromTop, IntProvider branchEndOffsetFromTop) {
    ...
    protected TrunkPlacerType<?> getType() {
        return ModTrunkPlacerType.CHORUS_TRUNK_PLACER;
    }
    ...
    public List<FoliagePlacer.TreeNode> generate(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random, int height, BlockPos startPos, TreeFeatureConfig config) {
        ...
        Direction direction2 = direction.rotateCounterclockwise(Direction.Axis.Y);
    ...
    static {
        ...
        CODEC = RecordCodecBuilder.mapCodec((instance) -> {
            ...
            }))).apply(instance, ChorusTrunkPlacer::new);
        });
    }
}
